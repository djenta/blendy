...
class CoreTests(unittest.TestCase):
    ...
    def test_system_prompt_requires_functional_tool_steps(self) -> None:
        ...
        self.assertIn("visually interpret that viewport before reading object names", core.SYSTEM_PROMPT)
        self.assertIn("Do not require the user to select the object, add a marker", core.SYSTEM_PROMPT)
        self.assertIn("An object named Sphere may visibly be a flattened dome", core.SYSTEM_PROMPT)
        self.assertIn("treat the rejected guidance as invalid", core.SYSTEM_PROMPT)
