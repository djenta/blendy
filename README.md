...
[![Download Blendy 2.1.1 for Windows](https://img.shields.io/badge/Download-Blendy%202.1.1%20for%20Windows-2ea44f?style=for-the-badge&logo=windows)](https://github.com/djenta/blendy/releases/latest)
...
```text
Blendy Local AI Tutor Setup 2.1.1.exe
```
...
1. Download `Blendy Local AI Tutor Setup 2.1.1.exe`.
2. Run the installer.
3. Open Blender.
